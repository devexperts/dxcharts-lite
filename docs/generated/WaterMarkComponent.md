...
|`setWaterMarkConfig`|`watermarkConfig: ChartConfigComponentsWaterMark` - The configuration object for the watermark.|`void`|Sets the watermark configuration for the chart.|
